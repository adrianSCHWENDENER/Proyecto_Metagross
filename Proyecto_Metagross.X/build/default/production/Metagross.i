...
void __attribute__((picinterrupt(("")))) isr(void) {
    ...
    if (PIR1bits.RCIF){
        ...
        else if (indicador == 0B00110001){
            Modo_Libre = 1;
        }
        else if (indicador == 0B00110010){
            Ataque(1);
        }
        else if (indicador == 0B00110011){
            Ataque(2);
        }
    }
    INTCONbits.T0IF = 0;
...
void main(void) {
    ...
    while(1){
        ...
        if (PORTBbits.RB0 && antiR1 == 1){
            escribirEEPROMH(0x04, CCP1);
            escribirEEPROMH(0x05, CCP2);
            escribirEEPROM(0x06, PWM1);
            escribirEEPROM(0x07, PWM2);
            antiR1 = 0;
        }
